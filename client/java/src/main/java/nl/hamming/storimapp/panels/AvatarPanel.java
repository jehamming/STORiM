...
public class AvatarPanel extends javax.swing.JPanel implements UserListener {
    ...
    private void saveAvatar() {
        ...
        if (newAvatar) {
            controllers.getUserController().addAvatarRequest(avatarName, avatarImage);
        } else {
            // Update !
            Long avatarID = Long.valueOf(lblAvatarID.getText());
            controllers.getUserController().updateAvatarRequest(avatarID, avatarName, avatarImage);
        }

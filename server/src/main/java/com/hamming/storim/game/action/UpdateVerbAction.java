...
import com.hamming.storim.model.dto.protocol.UpdateVerbDto;
...
public class UpdateVerbAction extends Action<UpdateVerbDto> {
    ...
    public void execute() {
        ...
        Verb verb = VerbFactory.getInstance().updateVerb(dto.getVerbId(), dto.getName(), dto.getShortName(), dto.getToCaller(), dto.getToLocation());
        if ( verb != null ) {
